...
'@ 'development'
    ...
    Assert-True ($all.total -eq 132) 'all-skills mode scores the complete 132-skill inventory'
    ...
    Assert-True ($stocktakeResult.total -eq 132) 'stocktake consumes all rubric results'
