...
Assert-FileContains "scripts/validate-references.ps1" "evaluation\[/\\\\\]skillopt.*runs" "reference validation excludes generated SkillOpt run snapshots"
...
Assert-FileContains ".github/workflows/quality-gates.yml" "tests/source-syntax-behavior.ps1" "PR quality gates parse all tracked source languages"
Assert-FileContains ".github/workflows/quality-gates.yml" "tests/restored-generator-smoke.ps1" "PR quality gates smoke-test restored generators"
Assert-FileContains ".github/workflows/quality-gates.yml" "tests/scrub-behavior.ps1" "PR quality gates run scrub behavior regressions"
