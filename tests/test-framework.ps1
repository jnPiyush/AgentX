...
Assert-FileContains ".github/skills/design/impeccable-integration/SKILL.md" "SHA-256" "Impeccable detector requires a verified native engine pin"
...
Assert-FileContains ".github/templates/UX-TEMPLATE.md" "Actually ran: <checks with evidence links, or none>" "UX template requires actual fallback evidence"
Assert-FileContains ".github/skills/design/impeccable-integration/SKILL.md" "Required fallback: T1-T10 \+ Honest Placeholders \+ axe \+ Pass 9 critique" "Impeccable integration distinguishes required checks from executed evidence"
