...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.15 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.15        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.15 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
