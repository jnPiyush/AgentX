...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.54 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.54        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.54 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
