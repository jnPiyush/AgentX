...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.48 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.48        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.48 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
