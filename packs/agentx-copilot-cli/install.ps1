...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.47 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.47        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.47 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
