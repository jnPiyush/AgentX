...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.19 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.19        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.19 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
