...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.8 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.8        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.8 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
