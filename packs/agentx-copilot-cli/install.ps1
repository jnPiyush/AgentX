...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.69 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.69        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.69 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
