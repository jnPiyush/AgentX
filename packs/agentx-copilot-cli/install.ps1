...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.61 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.61        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.61 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
