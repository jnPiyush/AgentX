...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.56 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.56        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.56 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
