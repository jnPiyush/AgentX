...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.39 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.39        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.39 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
