...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.50 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.50        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.50 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
