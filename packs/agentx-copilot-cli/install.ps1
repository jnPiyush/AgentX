...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.12 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.12        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.12 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
