...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.64 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.64        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.64 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
