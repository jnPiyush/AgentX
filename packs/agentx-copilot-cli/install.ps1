...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.46 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.46        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.46 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
