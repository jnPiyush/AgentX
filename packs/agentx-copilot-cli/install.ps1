...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.52 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.52        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.52 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
