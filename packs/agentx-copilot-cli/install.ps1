...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.42 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.42        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.42 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
