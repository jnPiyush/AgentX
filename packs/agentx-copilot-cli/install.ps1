...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.27 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.27        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.27 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
