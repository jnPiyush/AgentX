...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.70 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.70        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.70 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
