...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.1.2 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.1.2        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.1.2 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
