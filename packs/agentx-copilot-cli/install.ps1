...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.44 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.44        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.44 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
