...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.37 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.37        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.37 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
