...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.49 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.49        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.49 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
