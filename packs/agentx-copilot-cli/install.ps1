...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.5 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.5        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.5 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
