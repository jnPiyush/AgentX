...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.34 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.34        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.34 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
