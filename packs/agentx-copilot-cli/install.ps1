...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.7.1 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.7.1        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.7.1 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
 ...
 Write-Host " Skills        : 132 across 14 categories" -ForegroundColor White
