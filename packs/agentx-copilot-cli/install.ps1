...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.68 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.68        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.68 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
