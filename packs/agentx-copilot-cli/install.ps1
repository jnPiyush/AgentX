...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.24 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.24        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.24 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
