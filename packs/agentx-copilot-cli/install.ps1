...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.38 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.38        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.38 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
