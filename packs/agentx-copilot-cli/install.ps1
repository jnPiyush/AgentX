...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.45 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.45        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.45 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
