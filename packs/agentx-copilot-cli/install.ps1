...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.59 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.59        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.59 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
