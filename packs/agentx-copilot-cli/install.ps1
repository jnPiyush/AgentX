...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.66 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.66        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.66 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
