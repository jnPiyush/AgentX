...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.2.0 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.2.0        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.2.0 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
