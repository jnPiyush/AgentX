...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.33 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.33        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.33 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
