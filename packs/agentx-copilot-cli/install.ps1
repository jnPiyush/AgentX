...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.55 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.55        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.55 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
