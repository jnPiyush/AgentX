...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.53 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.53        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.53 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
