...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.58 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.58        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.58 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
