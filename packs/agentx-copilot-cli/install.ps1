...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.41 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.41        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.41 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
