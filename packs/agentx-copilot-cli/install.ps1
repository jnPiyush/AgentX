...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.7 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.7        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.7 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
