...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.62 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.62        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.62 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
