...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.51 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.51        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.51 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
