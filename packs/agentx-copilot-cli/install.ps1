...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.43 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.43        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.43 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
