...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.60 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.60        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.60 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
