...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.65 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.65        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.65 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
