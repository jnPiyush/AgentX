...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.35 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.35        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.35 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
