...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.31 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.31        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.31 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
