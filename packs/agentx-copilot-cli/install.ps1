...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.29 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.29        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.29 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
