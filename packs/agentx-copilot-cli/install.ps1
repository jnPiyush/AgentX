...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.10 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.10        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.10 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
