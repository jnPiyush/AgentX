...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.67 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.67        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.67 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
