...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.40 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.40        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.40 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
