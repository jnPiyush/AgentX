...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v9.0.0 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v9.0.0        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v9.0.0 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
