...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.3.2 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.3.2        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.3.2 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
