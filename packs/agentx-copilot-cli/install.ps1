...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.3.6 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.3.6        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.3.6 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
