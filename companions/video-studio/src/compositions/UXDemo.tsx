  ...
  return (
    ...
    >
      <div style={{ padding: "16px 28px", borderBottom: `1px solid ${brand.border}`, fontFamily: brand.fontMono, fontSize: 16, color: brand.textMuted, background: brand.bgPanel, display: "flex", gap: 12, alignItems: "center" }}>
        ...
        <span>Illustrative feedback-widget prototype</span>
      </div>
      <div style={{ display: "flex", height: "calc(100% - 56px)" }}>
        ...
        <div style={{ flex: 1, borderLeft: `1px solid ${brand.border}`, background: brand.bgPanel, padding: "32px 36px", fontFamily: brand.fontMono, fontSize: 14, color: brand.textMuted }}>
          <div style={{ fontFamily: brand.fontSans, fontSize: 13, letterSpacing: 2, textTransform: "uppercase", color: accent, fontWeight: 600, marginBottom: 18 }}>Illustrative audit checklist</div>
          <div style={{ color: brand.text, fontSize: 22, marginBottom: 14 }}>Not measured</div>
          <div style={{ marginBottom: 10 }}>WCAG 2.1 AA: review required</div>
          <div style={{ marginBottom: 10 }}>Keyboard nav: test required</div>
          <div style={{ marginBottom: 10 }}>Color contrast: test required</div>
          <div style={{ marginBottom: 10 }}>Focus order: test required</div>
          <div style={{ color: brand.textDim, marginTop: 24, fontSize: 12 }}>No audit report generated by this video</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <AbsoluteFill>
      ...
      <ThinkingPulse
        ...
        durationFrames={fps * 3}
        accent={accent}
        label="Illustrating wireframe generation"
      />
      ...
      <MetricBadge
        startFrame={fps * 48}
        accent={accent}
        primary="Wireframe to prototype: scripted example"
        secondary="Illustrative workflow. No measured timing or audit results."
      />
      <Outro
        startFrame={fps * 54}
        accent={accent}
        title="An illustrative UX workflow"
        subtitle="ux-designer.agent.md"
      />
      <div style={{ position: "absolute", bottom: 24, left: 120, right: 120, textAlign: "center", fontFamily: brand.fontSans, fontSize: 22, color: brand.text, background: brand.bgPanel, padding: "8px 16px", zIndex: 10 }}>
        Scripted illustration - not a recorded run or verified audit
      </div>
    </AbsoluteFill>
  );
};
