...
<#
.SYNOPSIS
 Install AgentX v7.2.1 - Download, copy, configure.
...
Write-Host "| AgentX v7.2.1 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
Write-OK "Version 7.2.1 recorded"
...
Write-Host " AgentX v7.2.1 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
