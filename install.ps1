...
<#
.SYNOPSIS
 Install AgentX v7.0.0 - Download, copy, configure.
...
Write-Host "| AgentX v7.0.0 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
Write-OK "Version 7.0.0 recorded"
...
Write-Host " AgentX v7.0.0 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
