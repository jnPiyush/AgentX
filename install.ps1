...
<#
.SYNOPSIS
 Install AgentX v9.0.0 - Download, copy, configure.
...
.EXAMPLE
 ...
 irm https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.ps1 | iex

 # One-liner for GitHub mode
 $env:AGENTX_MODE="github"; irm https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.ps1 | iex

 # One-liner to include Azure companion support
 $env:AGENTX_AZURE="true"; irm https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.ps1 | iex
#>
...
Write-Host "| AgentX v9.0.0 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
if ($previousVersion -and $previousVersion -ne "9.0.0") {
 $majorVersion = 0
 ...
 if ($majorVersion -lt 9) {
    Write-Host "[!] Detected AgentX v$previousVersion - upgrading to v9.0.0..." -ForegroundColor Yellow
...
Write-OK "Version 9.0.0 recorded"
...
Write-Host " AgentX v9.0.0 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
