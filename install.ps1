...
<#
.SYNOPSIS
 Install AgentX v8.4.10 - Download, copy, configure.
...
Write-Host "| AgentX v8.4.10 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
if ($previousVersion -and $previousVersion -ne "8.4.10") {
 $majorVersion = 0
 try { $majorVersion = [int]($previousVersion -split '\.')[0] } catch {}

 if ($majorVersion -lt 8) {
    Write-Host "[!] Detected AgentX v$previousVersion - upgrading to v8.4.10..." -ForegroundColor Yellow
...
Write-OK "Version 8.4.10 recorded"
...
Write-Host " AgentX v8.4.10 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
