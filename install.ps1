...
<#
.SYNOPSIS
 Install AgentX v8.7.1 - Download, copy, configure.
...
.EXAMPLE
 ...
 irm https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.ps1 | iex

 # One-liner for GitHub mode
 $env:AGENTX_MODE="github"; irm https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.ps1 | iex

 # One-liner to include Azure companion support
 $env:AGENTX_AZURE="true"; irm https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.ps1 | iex
#>
...
Write-Host "| AgentX v8.7.1 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
if ($previousVersion -and $previousVersion -ne "8.7.1") {
 $majorVersion = 0
 try { $majorVersion = [int]($previousVersion -split '\.')[0] } catch { Write-Verbose "Could not parse major version from '$previousVersion'." }

 if ($majorVersion -lt 8) {
    Write-Host "[!] Detected AgentX v$previousVersion - upgrading to v8.7.1..." -ForegroundColor Yellow
...
Write-OK "Version 8.7.1 recorded"
...
Write-Host " AgentX v8.7.1 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
