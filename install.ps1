...
<#
.SYNOPSIS
 Install AgentX v8.4.24 - Download, copy, configure.
...
Write-Host "| AgentX v8.4.24 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
if ($previousVersion -and $previousVersion -ne "8.4.24") {
 $majorVersion = 0
 try { $majorVersion = [int]($previousVersion -split '\.')[0] } catch {}

 if ($majorVersion -lt 8) {
    Write-Host "[!] Detected AgentX v$previousVersion - upgrading to v8.4.24..." -ForegroundColor Yellow
...
Write-OK "Version 8.4.24 recorded"
...
Write-Host " AgentX v8.4.24 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
