...
<#
.SYNOPSIS
 Install AgentX v7.2.0 - Download, copy, configure.
...
Write-Host "| AgentX v7.2.0 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
Write-OK "Version 7.2.0 recorded"
...
Write-Host " AgentX v7.2.0 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
