...
def main() -> None:
    ...
    parser.add_argument(
        "--layout", choices=["src", "flat"], default="src", help="Project layout"
    )
    parser.add_argument(
        "--type", choices=["basic", "fastapi"], default="basic", help="Project type"
    )
    parser.add_argument(
        "--output", default=".", help="Parent directory for the project"
    )
