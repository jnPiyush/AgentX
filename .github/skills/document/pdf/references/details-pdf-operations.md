# PDF Operations Detail

> Read this when the [pdf](../SKILL.md) root tells you to choose a PDF library,
> run a specific file operation, or decide when OCR is required. Content below
> is relocated verbatim from the original root so the detailed recipes remain
