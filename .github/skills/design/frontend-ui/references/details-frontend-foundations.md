# Frontend/UI Development - Detailed Foundations

> Read this when the [frontend-ui](../SKILL.md) root sends you here for the
> original quick reference tables, semantic HTML examples, anti-patterns,
> resources, or troubleshooting details. The moved sections below are preserved
