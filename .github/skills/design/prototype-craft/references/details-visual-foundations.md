# Prototype Craft - Visual Foundations

> Read this when the [prototype-craft](../SKILL.md) root sends you here for the
> original craft rules, visual-system code samples, and CSS framework guidance.
> The sections below are preserved verbatim from the original root.
