# Accessibility - POUR Checklist Detail

> Read this when applying the [accessibility](../SKILL.md) gate to a specific
> surface, running the prototype-auditor Accessibility pass, or wiring CI
> verification hooks. Content below is relocated verbatim from the skill root
> to stay within the root token budget; nothing was summarized away.
