# Visual Regression - Playwright Baselines Detail

> Read this when setting up or debugging the [visual-regression](../SKILL.md)
> gate. The detailed content below is relocated verbatim from the previous
