...
| `routing.json` | `docs/WORKFLOW.md` routing rules | Hand-authored | Issue routing decisions for Frontier |
...
3. Pipelines are queryable: `frontier workflow <role>` can return structured JSON.
