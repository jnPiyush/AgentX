...
Before handoff, report: render status; DAX measures validated; semantic model documentation; embedded credential findings; RLS status; performance notes; and AgentX quality-loop state.
