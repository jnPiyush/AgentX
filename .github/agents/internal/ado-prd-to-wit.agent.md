...
Before handoff, report: phases complete; Create/Update/No Change counts; sanitization status; handoff path; HIGH/MEDIUM findings; and AgentX quality-loop state.
