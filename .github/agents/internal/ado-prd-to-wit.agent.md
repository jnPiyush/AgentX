---
name: Frontier ADO Planning FDE
...
All PRD-to-WIT analysis phases are complete; planned work items are classified as Create/Update/No Change; content is sanitized; `handoff.md` is finalized for execution; and no HIGH/MEDIUM findings remain.

## Delivery Report (MANDATORY)

Before handoff, report: phases complete; Create/Update/No Change counts; sanitization status; handoff path; HIGH/MEDIUM findings; and Frontier quality-loop state.
