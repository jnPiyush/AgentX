...
Prompts are stored as separate files rather than inline strings; structured rubric evaluation is documented; primary and fallback models are tested when required; semantic versioning/changelog is updated; and adversarial or edge cases are covered.
