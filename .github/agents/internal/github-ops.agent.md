...
Before handoff, report: issues created/updated/closed/labeled; duplicate-check status; blocked or ambiguous items; persisted state path; and AgentX quality-loop state.
