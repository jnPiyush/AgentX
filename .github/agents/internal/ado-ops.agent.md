...
Requested ADO work items are created or updated; workflow state is persisted; process-template naming is respected; content sanitization is applied; `handoff.md` is written when required; and no HIGH/MEDIUM findings remain.
