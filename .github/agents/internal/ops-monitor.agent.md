...
Tracing/telemetry is instrumented where in scope; baselines are saved from known-good behavior; drift thresholds are justified; P0-P3 alert tiers include response procedures; and cost/latency are tracked alongside quality metrics.
