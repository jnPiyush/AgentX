...
Before handoff, report: rubric status; judge agreement; model count/provider diversity; primary and fallback scores; result path; and AgentX quality-loop state.
