...
Before handoff, report: chunking strategy; hybrid search status; RAGAS or retrieval metric values; citation/source-attribution status; embedding selection evidence; and AgentX quality-loop state.
