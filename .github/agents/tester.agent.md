...
Before handoff, report: unit/integration/E2E pass counts; coverage gate; defects raised; certification report status; unresolved findings; and AgentX quality-loop state.
