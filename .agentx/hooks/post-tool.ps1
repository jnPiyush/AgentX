...
[CmdletBinding()]
param(
    [string]$Summary = $(if ($env:FRONTIER_ITERATION_SUMMARY) { $env:FRONTIER_ITERATION_SUMMARY } elseif ($env:HVE_ITERATION_SUMMARY) { $env:HVE_ITERATION_SUMMARY } else { $env:AGENTX_ITERATION_SUMMARY }),
