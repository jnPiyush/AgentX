...
irm https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.ps1 | iex    # PowerShell
curl -fsSL https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.sh | bash  # Bash
```
...
PROFILE=python curl -fsSL https://raw.githubusercontent.com/jnPiyush/AgentX/v8.7.1/install.sh | bash
```
