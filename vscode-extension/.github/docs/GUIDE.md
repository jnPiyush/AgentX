...
irm https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.ps1 | iex    # PowerShell
curl -fsSL https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.sh | bash  # Bash
```
...
PROFILE=python curl -fsSL https://raw.githubusercontent.com/jnPiyush/AgentX/v9.0.0/install.sh | bash
```
