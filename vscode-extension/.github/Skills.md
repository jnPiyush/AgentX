...
| **Completion Verification (before claiming done)** | [Verification Before Completion](agentx/skills/development/verification-before-completion/SKILL.md), [Iterative Loop](agentx/skills/development/iterative-loop/SKILL.md), [Testing](agentx/skills/development/testing/SKILL.md) |
| **Stalled / Repeat-Failure Debugging** | [Systematic Debugging](agentx/skills/development/systematic-debugging/SKILL.md), [Karpathy Guidelines](agentx/skills/development/karpathy-guidelines/SKILL.md), [Error Handling](agentx/skills/development/error-handling/SKILL.md), [Logging](agentx/skills/development/logging-monitoring/SKILL.md) |
...
| **Anthropic Claude Implementation** | [Anthropic Claude](agentx/skills/ai-systems/anthropic-claude/SKILL.md), [Prompt Eng](agentx/skills/ai-systems/prompt-engineering/SKILL.md), [Context Mgmt](agentx/skills/ai-systems/context-management/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md) |
| **Multi-Agent System** | [Multi-Agent Orchestration](agentx/skills/ai-systems/multi-agent-orchestration/SKILL.md), [Tool Use](agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md), [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md), [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md) |
| **LLM Tool / Function Calling** | [Tool Use](agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md), [Prompt Eng](agentx/skills/ai-systems/prompt-engineering/SKILL.md), [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md), [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md) |
| **Reasoning Model Tasks** | [Reasoning Models](agentx/skills/ai-systems/reasoning-models/SKILL.md), [Prompt Eng](agentx/skills/ai-systems/prompt-engineering/SKILL.md), [LLM Gateway](agentx/skills/ai-systems/llm-gateway-and-routing/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md) |
| **AI Safety / Red Team** | [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md), [Tool Use](agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md), [RAG Pipelines](agentx/skills/ai-systems/rag-pipelines/SKILL.md) |
| **Agent Observability** | [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md), [GenAIOps](agentx/skills/ai-systems/genaiops/SKILL.md), [Prompt Versioning](agentx/skills/ai-systems/prompt-versioning/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md) |
| **Vector DB Selection** | [Vector Databases](agentx/skills/ai-systems/vector-databases/SKILL.md), [RAG Pipelines](agentx/skills/ai-systems/rag-pipelines/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md) |
| **Computer Use / Browser Agent** | [Computer Use](agentx/skills/ai-systems/computer-use-and-browser-agents/SKILL.md), [Tool Use](agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md), [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md), [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md) |
| **LLM Gateway / Routing** | [LLM Gateway](agentx/skills/ai-systems/llm-gateway-and-routing/SKILL.md), [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md), [Prompt Versioning](agentx/skills/ai-systems/prompt-versioning/SKILL.md), [GenAIOps](agentx/skills/ai-systems/genaiops/SKILL.md) |
| **Voice Agent (Realtime)** | [Voice Agents](agentx/skills/ai-systems/voice-agents/SKILL.md), [Tool Use](agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md), [Agent Observability](agentx/skills/ai-systems/agent-observability/SKILL.md), [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md) |
| **Synthetic Data Generation** | [Synthetic Data](agentx/skills/ai-systems/synthetic-data-generation/SKILL.md), [AI Evaluation](agentx/skills/ai-systems/ai-evaluation/SKILL.md), [Model Fine-Tuning](agentx/skills/ai-systems/model-fine-tuning/SKILL.md), [AI Safety](agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md) |
| **Agent Memory** | [Agent Memory](agentx/skills/ai-systems/agent-memory-systems/SKILL.md), [Vector Databases](agentx/skills/ai-systems/vector-databases/SKILL.md), [Context Mgmt](agentx/skills/ai-systems/context-management/SKILL.md), [Cognitive Arch](agentx/skills/ai-systems/cognitive-architecture/SKILL.md) |
...
| **Design Language for a Target App** | [Impeccable Integration](agentx/skills/design/impeccable-integration/SKILL.md), [Design System Reasoning](agentx/skills/design/design-system-reasoning/SKILL.md), [Brand Spec Extraction](agentx/skills/design/brand-spec-extraction/SKILL.md), [Anti-Slop](agentx/skills/design/anti-slop/SKILL.md) |
| **UI Slop Prevention (before emitting any UI)** | [Impeccable Integration](agentx/skills/design/impeccable-integration/SKILL.md), [Anti-Slop](agentx/skills/design/anti-slop/SKILL.md), [Prototype Audit](agentx/skills/design/prototype-audit/SKILL.md), [Prototype Craft](agentx/skills/design/prototype-craft/SKILL.md), [Design System Reasoning](agentx/skills/design/design-system-reasoning/SKILL.md) |
| **Brand Spec from URL / Screenshot** | [Brand Spec Extraction](agentx/skills/design/brand-spec-extraction/SKILL.md), [Design System Reasoning](agentx/skills/design/design-system-reasoning/SKILL.md), [Anti-Slop](agentx/skills/design/anti-slop/SKILL.md), [Accessibility](agentx/skills/design/accessibility/SKILL.md) |
...
| **UX Usability Heuristic Eval** | [Usability Heuristics](agentx/skills/design/usability-heuristics/SKILL.md), [Prototype Audit](agentx/skills/design/prototype-audit/SKILL.md), [Content Design](agentx/skills/design/content-design/SKILL.md), [Accessibility](agentx/skills/design/accessibility/SKILL.md) |
| **UX Content / Microcopy** | [Content Design](agentx/skills/design/content-design/SKILL.md), [UX/UI Design](agentx/skills/design/ux-ui-design/SKILL.md), [Accessibility](agentx/skills/design/accessibility/SKILL.md), [Prototype Audit](agentx/skills/design/prototype-audit/SKILL.md) |
| **UX Visual Regression** | [Visual Regression](agentx/skills/design/visual-regression/SKILL.md), [Browser Automation](agentx/skills/development/browser-automation/SKILL.md), [E2E Testing](agentx/skills/testing/e2e-testing/SKILL.md), [Prototype Audit](agentx/skills/design/prototype-audit/SKILL.md) |
...
arch|cost-analysis|agentx/skills/architecture/cost-analysis/SKILL.md|cost,estimate,pricing,idle-vs-active,load-envelope,run-rate,ADR-cost-column,budget
arch|infra-governance|agentx/skills/architecture/infra-governance/SKILL.md|IaC-policy,capability-invariant,companion-resource,naming-resolver,workload-topology,terraform,bicep,governance-gate
...
dev|cowork-plugin-creator|agentx/skills/development/cowork-plugin-creator/SKILL.md|Microsoft-365-Copilot,Cowork,plugin,manifest.json,agentSkills,agentConnectors,MCP,app-package
...
ai|anthropic-claude|agentx/skills/ai-systems/anthropic-claude/SKILL.md|Claude,Anthropic,Messages-API,tool-use,prompt-caching,extended-thinking,Bedrock,Vertex,Claude-Agent-SDK
ai|multi-agent-orchestration|agentx/skills/ai-systems/multi-agent-orchestration/SKILL.md|multi-agent,supervisor,swarm,handoff,hierarchical,graph,A2A,AutoGen,CrewAI,OpenAI-Agents-SDK,Microsoft-Agent-Framework
ai|tool-use|agentx/skills/ai-systems/tool-use-and-function-calling/SKILL.md|tool-use,function-calling,JSON-Schema,structured-outputs,parallel-tools,tool-error,idempotency
ai|agent-observability|agentx/skills/ai-systems/agent-observability/SKILL.md|OpenTelemetry,GenAI-conventions,Langfuse,LangSmith,Phoenix,Helicone,OpenLLMetry,traces,metrics,cost
ai|reasoning-models|agentx/skills/ai-systems/reasoning-models/SKILL.md|o-series,o3,GPT-5-thinking,extended-thinking,DeepSeek-R1,Gemini-Thinking,reasoning_effort,planner-executor
ai|ai-safety|agentx/skills/ai-systems/ai-safety-and-red-teaming/SKILL.md|prompt-injection,indirect-injection,jailbreak,LlamaGuard,ShieldGemma,Prompt-Shields,PyRIT,Garak,promptfoo,OWASP-LLM
ai|vector-databases|agentx/skills/ai-systems/vector-databases/SKILL.md|Azure-AI-Search,Pinecone,Qdrant,Weaviate,Milvus,pgvector,LanceDB,HNSW,DiskANN,hybrid-search,embeddings
ai|computer-use|agentx/skills/ai-systems/computer-use-and-browser-agents/SKILL.md|Computer-Use,Operator,CUA,browser-use,Playwright,Browserbase,E2B,sandboxing,screenshots
ai|llm-gateway|agentx/skills/ai-systems/llm-gateway-and-routing/SKILL.md|LiteLLM,Portkey,Azure-AI-Gateway,APIM,OpenRouter,routing,fallback,semantic-cache,rate-limit
...
ai|iterative-retrieval|agentx/skills/ai-systems/iterative-retrieval/SKILL.md|subagent,scoped-reads,progressive-context,citation
...
design|anti-slop|agentx/skills/design/anti-slop/SKILL.md|anti-slop,AI-slop,purple-gradients,honest-placeholders,forbidden-tells,T1-T10,placeholder-policy
design|impeccable-integration|agentx/skills/design/impeccable-integration/SKILL.md|impeccable,design-language,DESIGN.md,PRODUCT.md,detector,59-rules,slop-detection,three-state-gate,DEGRADED,waivers
design|brand-spec-extraction|agentx/skills/design/brand-spec-extraction/SKILL.md|brand-spec,brand-extraction,5-step-protocol,palette-extraction,voice-extraction,brand-from-url,brand-from-screenshot
...
design|prototype-audit|agentx/skills/design/prototype-audit/SKILL.md|8-pass-audit,self-healing,axe,Lighthouse,responsive-check,routes,build-hygiene,heuristics,visual-regression,auto-fix
design|usability-heuristics|agentx/skills/design/usability-heuristics/SKILL.md|Nielsen-10,heuristic-evaluation,severity-rubric,cognitive-walkthrough,H1-H10,S0-S4
design|content-design|agentx/skills/design/content-design/SKILL.md|microcopy,empty-states,error-messages,voice-tone,length-budgets,localization,inclusive-language
design|visual-regression|agentx/skills/design/visual-regression/SKILL.md|Playwright,toHaveScreenshot,snapshot-diff,baselines,Chromatic,Percy,Applitools,maxDiffPixelRatio
