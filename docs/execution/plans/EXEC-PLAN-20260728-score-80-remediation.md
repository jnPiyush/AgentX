...
**Issue**: #377
**Baseline evaluation**: 2026-07-28 solution evaluation (archived outside the current source tree)
...
The 2026-07-29 solution evaluation containing the arithmetic and delta ledgers is
archived outside the current source tree. Do not report 80+ until the remote
evidence exists.
