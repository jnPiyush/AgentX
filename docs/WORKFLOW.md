...
- at least one screenshot per primary route or component state, captured via the [`browser-automation`](../.github/skills/development/browser-automation/SKILL.md) skill against the running build
...
- the Originality row in the [REVIEW-TEMPLATE weighted scoring](../.github/templates/REVIEW-TEMPLATE.md#14-decision) is graded, not skipped
