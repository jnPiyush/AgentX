...
| [Skills.md](Skills.md) | 131 production code skills index (load only relevant skills per task) |
...
| `.github/skills/` | 131 skill files across 14 categories |
...
| `.github/prompts/` | 22 reusable prompt templates |
